DIDComm Messaging v2.1 Editor's Draft
==================
...
**Changelog**
**2.1** - Added a minor variation of the `serviceEndpoint` block format to allow easier use by ION DIDs. Allowed `body` element to be absent if empty.
