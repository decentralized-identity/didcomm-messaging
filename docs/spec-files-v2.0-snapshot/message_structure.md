...
![DIDComm envelopes](../collateral-v2.0-snapshot/didcomm-envelopes.png)
...
When persisted as a file or attached as a payload in other contexts, the file extension for DIDComm signed messages SHOULD be `dcsm`, giving a globbing pattern of `*.dcsm`; this SHOULD be be read as "Star Dot D C S M" or as "D C S M" files. A possible icon for this media type depicts a signed envelope ([svg](../collateral-v2.0-snapshot/dcsm.svg) | [256x256](../collateral-v2.0-snapshot/dcsm-256.png) | [128x128](../collateral-v2.0-snapshot/dcsm-128.png) | [64x64](../collateral-v2.0-snapshot/dcsm-64.png)):

![DIDComm Signed Message Icon](../collateral-v2.0-snapshot/dcsm-128.png)
...
When persisted as a file or attached as a payload in other contexts, the file extension for DIDComm encrypted messages SHOULD be `dcem`, giving a globbing pattern of `*.dcem`; this SHOULD be read as "Star Dot D C E M" or as "D C E M" files. A possible icon for this file format depicts an envelope with binary overlay, protected by a lock ([svg](../collateral-v2.0-snapshot/dcem.svg) | [256x256](../collateral-v2.0-snapshot/dcem-256.png) | [128x128](../collateral-v2.0-snapshot/dcem-128.png) | [64x64](../collateral-v2.0-snapshot/dcem-64.png)):

![DIDComm Encrypted Message Icon](../collateral-v2.0-snapshot/dcem-128.png)
