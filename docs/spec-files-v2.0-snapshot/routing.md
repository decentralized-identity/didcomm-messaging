...
![ordinary sequence](../collateral-v2.0-snapshot/routing-roles.png)
...
![](../collateral-v2.0-snapshot/routing-state-machines.png)]
...
![re-wrapped sequence](../collateral-v2.0-snapshot/routing-roles-2.png)
